...
type BaseLocationFilter<Fields, SupportedTypes, ValueType, Prefix extends string, QueryFilter extends string = ''> = NonEmpty<NonNullable<{
 ...
 */
type BoundingBoxSearchFilter<Fields, Prefix extends string> = BaseLocationFilter<Fields, Types, BoundingBoxSearchFilterInput, Prefix, 'within'>;
/**
 * @desc within - location in a bounding circle
 * @see [Documentation]{@link https://www.contentful.com/developers/docs/references/content-delivery-api/#/reference/search-parameters/locations-in-a-bounding-object}
 */
type BoundingCircleSearchFilter<Fields, Prefix extends string> = BaseLocationFilter<Fields, Types, BoundingCircleSearchFilterInput, Prefix, 'within'>;
/**
 ...
 */
export type LocationSearchFilters<Fields, Prefix extends string> = ProximitySearchFilter<Fields, Prefix> | BoundingBoxSearchFilter<Fields, Prefix> | BoundingCircleSearchFilter<Fields, Prefix>;
export {};
