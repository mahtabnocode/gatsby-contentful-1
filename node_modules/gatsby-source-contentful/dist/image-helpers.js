...
const mimeTypeExtensions = new Map([[`image/jpeg`, `.jpg`], [`image/jpg`, `.jpg`], [`image/gif`, `.gif`], [`image/png`, `.png`], [`image/webp`, `.webp`], [`image/avif`, `.avif`]]);

// Check if Contentful asset is actually an image
exports.mimeTypeExtensions = mimeTypeExtensions;
function isImage(image) {
  return mimeTypeExtensions.has(image === null || image === void 0 ? void 0 : image.mimeType);
}
