...
/* harmony import */ var _utils_typography__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(9175);
/* harmony import */ var _layouts__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(4458);
const propTypes={data:prop_types__WEBPACK_IMPORTED_MODULE_4__.object.isRequired};const Product=({node})=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{style:{color:`inherit`,textDecoration:`none`},to:node.gatsbyPath},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{display:`flex`,alignItems:`center`,borderBottom:`1px solid lightgray`,paddingBottom:(0,_utils_typography__WEBPACK_IMPORTED_MODULE_2__.rhythm)(1/2),marginBottom:(0,_utils_typography__WEBPACK_IMPORTED_MODULE_2__.rhythm)(1/2)}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{marginRight:(0,_utils_typography__WEBPACK_IMPORTED_MODULE_2__.rhythm)(1/2)}},node.image[0].gatsbyImageData&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__/* .GatsbyImage */ .HN,{style:{margin:0},image:node.image[0].gatsbyImageData})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{flex:1}},node.productName.productName))));class IndexPage extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component){render(){const usProductEdges=this.props.data.us.edges;const deProductEdges=this.props.data.german.edges;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .Z,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{marginBottom:(0,_utils_typography__WEBPACK_IMPORTED_MODULE_2__.rhythm)(2)}},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",null,`Gatsby's`," integration with the Contentful Image API"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{to:"/image-api/"},"See examples"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h2",null,"Localization"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,"The ",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("code",null,"gatsby-source-contentful")," plugin offers full support for ",`Contentful's`," localization features. Our sample space includes products localized into both English and German."),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("p",null,"An entry and asset node are created for each locale following fallback rules for missing localization. In addition, each node has an additional field added, ",/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("code",null,"node_locale")," so you can select for nodes from a single locale"),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",null,"en-US"),usProductEdges.map(({node},i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Product,{node:node,key:node.id})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("br",null),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h3",null,"de"),deProductEdges.map(({node},i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(Product,{node:node,key:node.id}))));}}IndexPage.propTypes=propTypes;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (IndexPage);const pageQuery="336946627";
