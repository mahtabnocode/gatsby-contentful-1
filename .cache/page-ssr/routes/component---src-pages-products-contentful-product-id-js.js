...
/* harmony import */ var _layouts__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(4458);
/* harmony import */ var _utils_typography__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(9175);
const propTypes={data:prop_types__WEBPACK_IMPORTED_MODULE_4__.object.isRequired};class ProductTemplate extends (react__WEBPACK_IMPORTED_MODULE_0___default().Component){render(){var _image$;const product=this.props.data.contentfulProduct;const{productName:{productName},productDescription,price,image,brand,categories}=product;const productImg=(_image$=image[0])===null||_image$===void 0?void 0:_image$.gatsbyImageData;return/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(_layouts__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .Z,null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{style:{display:`flex`,justifyContent:`center`}},productImg&&/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby_plugin_image__WEBPACK_IMPORTED_MODULE_5__/* .GatsbyImage */ .HN,{style:{marginBottom:(0,_utils_typography__WEBPACK_IMPORTED_MODULE_3__.rhythm)(1)},image:productImg})),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h1",{style:{marginBottom:(0,_utils_typography__WEBPACK_IMPORTED_MODULE_3__.rhythm)(1/2)}},productName),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("h4",null,"Made by ",brand.companyName.companyName),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",null,"Price: $",price),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",{dangerouslySetInnerHTML:{__html:productDescription.childMarkdownRemark.html}}),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("div",null,/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("span",null,"See other: "),/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("ul",null,categories.map((category,i)=>/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement("li",{key:i},/*#__PURE__*/react__WEBPACK_IMPORTED_MODULE_0___default().createElement(gatsby__WEBPACK_IMPORTED_MODULE_1__.Link,{key:i,to:category.gatsbyPath},category.title.title)))))));}}ProductTemplate.propTypes=propTypes;/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (ProductTemplate);const pageQuery="2278476839";

/***/ })

};
;
//# sourceMappingURL=component---src-pages-products-contentful-product-id-js.js.map